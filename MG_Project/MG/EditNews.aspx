<%@ Page Title="" Language="C#" MasterPageFile="~/MsAdminPanel.master" AutoEventWireup="true" CodeFile="EditNews.aspx.cs" Inherits="EditNews" %>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <% } %>
                            <asp:Panel ID="pnlEditNews" runat="server" Visible="True">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox ID="txtSaveDate" runat="server" Height="35px" Width="275px" Enabled="False" MaxLength="10"></asp:TextBox>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <!-- /.form group -->
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    ...
                                    <asp:Panel ID="pnlExpiredDate" runat="server" Visible="False">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox ID="txtExpDate" runat="server" Height="35px" Width="275px" Enabled="True" placeholder="روز/ماه/سال" MaxLength="10"></asp:TextBox>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
                                ...
                                <div class="form-group">
                                    <asp:Label ID="lblShowStatus" runat="server" Text="وضعیت خبر: " Visible="True"></asp:Label>
                                    <br />
                                    <br />
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <asp:DropDownList ID="drpDnLstStatus" runat="server" Width="175px" Enabled="False" Visible="True">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label1" runat="server" Text="دسترسی ثبت نظرات: " Visible="True"></asp:Label>
                                    <br />
                                    <br />
                                    <div class="input-group">
                                        <div class="input-group-prepend">
