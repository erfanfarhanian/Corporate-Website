<%@ Page Title="" Language="C#" MasterPageFile="~/MsAdminPanel.master" AutoEventWireup="true" CodeFile="EditNotification.aspx.cs" Inherits="EditNotification" %>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">ویرایش اطلاعیه</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <% } %>
                            <asp:Panel ID="pnlEditNotification" runat="server" Visible="True">
                                ...
                                <hr>
                                <asp:Button CssClass="btn btn-success" ID="btnEditNotification" runat="server" Text="ویرایش" OnClick="btnEditNotification_Click" />
                                &nbsp;&nbsp;&nbsp;
