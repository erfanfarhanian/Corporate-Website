...
public partial class MsDefault : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["UserIdS"] == null || Session["RegisterStatusS"].ToString() == "0")
        {
            lblLoginnedUser.Text = "هنوز کاربری وارد نشده است";
        }
        else
        {
            lblLoginnedUser.Text = "کاربر: " + Session["FullNameS"].ToString();
        }
