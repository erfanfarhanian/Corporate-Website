<%@ Page Title="" Language="C#" MasterPageFile="~/MsAdminPanel.master" AutoEventWireup="true" CodeFile="InsertUser.aspx.cs" Inherits="InsertUser" %>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <% } %>
                            <asp:Panel ID="pnlInsertUser" runat="server" Visible="True">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox ID="txtPassword" runat="server" placeholder="کلمه عبور را وارد کنید..." Height="35px" Width="398px" MaxLength="15" TextMode="Password"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox ID="txtRepeatedPass" runat="server" placeholder="تکرار کلمه عبور را وارد کنید..." Height="35px" Width="398px" MaxLength="15" TextMode="Password"></asp:TextBox>
                                        <asp:Label CssClass="text text-danger" ID="lblRepeatedPass" runat="server" Text="لطفا تکرار کلمه عبور را وارد کنید." Visible="False"></asp:Label>
                                        <asp:Label CssClass="text text-danger" ID="lblWrongRepeatedPass" runat="server" Text="کلمه ی عبور با تکرار آن همخوانی ندارد.." Visible="False"></asp:Label>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <!-- /.form group -->
                                ...
                                <div class="form-group">
                                    <label>مدرک تحصیلی(اختیاری) :</label>
                                    <br />
                                    <br />
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    <label>رشته تحصیلی(اختیاری) :</label>
                                    <br />
                                    <br />
                                    <div class="input-group">
                                        <div class="input-group-prepend">
