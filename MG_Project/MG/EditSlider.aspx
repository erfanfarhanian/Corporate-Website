<%@ Page Title="" Language="C#" MasterPageFile="~/MsAdminPanel.master" AutoEventWireup="true" CodeFile="EditSlider.aspx.cs" Inherits="EditSlider" %>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <% } %>
                            <asp:Panel ID="pnlEditSlider" runat="server" Visible="True">
                                <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <fieldset style="width: 250px;">
                                            ...
                                            <asp:Label CssClass="text text-danger" ID="lblEmpPic" runat="server" Text="لطفا تصویری برای اسلایدر را انتخاب کنید." Visible="False"></asp:Label>
                                        </fieldset>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <!-- /.form group -->
                                <hr>
                                <asp:Button CssClass="btn btn-success" ID="btnUpdateSlider" runat="server" Text="ویرایش" OnClick="btnUpdateSlider_Click" />
                                &nbsp;&nbsp;&nbsp;
