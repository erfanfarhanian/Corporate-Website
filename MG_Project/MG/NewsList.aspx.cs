...
public partial class NewsList : System.Web.UI.Page
{
    ...
    private void GetCustomersPageWise(int pageIndex)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_Tbl_News_Paging", con))
            {
    ...
    public DataSet Bind()
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT * FROM Tbl_News WHERE TitleNews LIKE N'%" + txtSearch.Text + "%' OR STextNews LIKE N'%" + txtSearch.Text + "%' OR LTextNews LIKE N'%" + txtSearch.Text + "%' ORDER BY NewsID DESC", con);
